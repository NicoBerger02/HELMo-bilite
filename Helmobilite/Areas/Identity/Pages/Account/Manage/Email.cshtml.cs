...
namespace Helmobilite.Areas.Identity.Pages.Account.Manage
{
	...
	public class EmailModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            ///     directly from your code. This API may change or be removed in future releases.
            /// </summary>
            [Required(ErrorMessage = "Veuillez entrer votre nouvel email")]
        ...
        public async Task<IActionResult> OnPostChangeEmailAsync()
        {
            ...
            {
				var result = await _userManager.SetUserNameAsync(user, Input.NewEmail);
				if (result.Succeeded)
				{
					...
					StatusMessage = "Votre adresse email a été modifiée";
					return RedirectToPage();
				} else
                {
                    StatusMessage = "Erreur : L'adresse email est déjà utilisée";
				}
			}
            return RedirectToPage();
        }
