...
namespace Helmobilite.Areas.Identity.Pages.Account.Manage
{
	...
	public class ChangePasswordModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            ///     directly from your code. This API may change or be removed in future releases.
            /// </summary>
            [Required(ErrorMessage = "Veuillez entrer votre mot de passe actuel")]
			...
			///     directly from your code. This API may change or be removed in future releases.
			/// </summary>
			[Required(ErrorMessage = "Veuillez entrer votre nouveau mot de passe")]
			[DataType(DataType.Password)]
			...
			[Compare("NewPassword", ErrorMessage = "Le mot de passe et la confirmation sont différents")]
