...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Helmobilite.Models.Address", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("PostCodeAddress")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Helmobilite.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Helmobilite.Models.ChauffeurLicense", b =>
                {
                    ...
                    b.HasKey("ChauffeurId", "License");

                    b.ToTable("ChauffeurLicense");
                });
            ...
            modelBuilder.Entity("Helmobilite.Models.Client", b =>
                {
                    b.HasBaseType("Helmobilite.Models.ApplicationUser");
            ...
            modelBuilder.Entity("Helmobilite.Models.Member", b =>
                {
                    b.HasBaseType("Helmobilite.Models.ApplicationUser");
            ...
            modelBuilder.Entity("Helmobilite.Models.Administrator", b =>
                {
                    b.HasBaseType("Helmobilite.Models.Member");

                    b.HasDiscriminator().HasValue("Administrator");
                });

            modelBuilder.Entity("Helmobilite.Models.Chauffeur", b =>
                {
                    b.HasBaseType("Helmobilite.Models.Member");
            ...
            modelBuilder.Entity("Helmobilite.Models.Address", b =>
                {
                    b.HasOne("Helmobilite.Models.Client", "Client")
                        .WithOne("Address")
                        .HasForeignKey("Helmobilite.Models.Address", "ClientId")
            ...
            modelBuilder.Entity("Helmobilite.Models.ChauffeurLicense", b =>
                {
                    b.HasOne("Helmobilite.Models.Chauffeur", "Chauffeur")
                        .WithMany("Licenses")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Helmobilite.Models.ApplicationUser", null)
                        .WithMany()
